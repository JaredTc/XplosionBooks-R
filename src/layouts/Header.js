        ...
        <div className="container-fluid  ">
          ...
          <div className="collapse  navbar-collapse " id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 ">
              ...
              <li className="nav-item">
              <Link  className="nav-link active hov" aria-current="page" to="/"> Contactanos</Link>
              </li>
              <li className="nav-item">
              <Link  className="nav-link active hov" aria-current="page" to="/"> Registro</Link>
              </li>
              <li className="nav-item">
              <Link  className="nav-link active hov" aria-current="page" to="/"> Iniciar Sesion</Link>
              </li>
